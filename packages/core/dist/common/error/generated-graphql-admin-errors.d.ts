...
export declare class AlreadyRefundedError extends ErrorResult {
    ...
    constructor(input: { refundId: Scalars['ID'] });
}
export declare class CancelActiveOrderError extends ErrorResult {
    ...
    constructor(input: { orderState: Scalars['String'] });
}
export declare class CancelPaymentError extends ErrorResult {
    ...
    constructor(input: { paymentErrorMessage: Scalars['String'] });
}
export declare class ChannelDefaultLanguageError extends ErrorResult {
    ...
    constructor(input: { channelCode: Scalars['String']; language: Scalars['String'] });
}
export declare class CouponCodeExpiredError extends ErrorResult {
    ...
    constructor(input: { couponCode: Scalars['String'] });
}
...
export declare class CouponCodeLimitError extends ErrorResult {
    ...
    constructor(input: { couponCode: Scalars['String']; limit: Scalars['Int'] });
}
export declare class CreateFulfillmentError extends ErrorResult {
    ...
    constructor(input: { fulfillmentHandlerError: Scalars['String'] });
}
export declare class DuplicateEntityError extends ErrorResult {
    ...
    constructor(input: { duplicationError: Scalars['String'] });
}
...
export declare class GuestCheckoutError extends ErrorResult {
    ...
    constructor(input: { errorDetail: Scalars['String'] });
}
...
export declare class InsufficientStockError extends ErrorResult {
    ...
    constructor(input: { order: any; quantityAvailable: Scalars['Int'] });
}
...
export declare class InvalidCredentialsError extends ErrorResult {
    ...
    constructor(input: { authenticationError: Scalars['String'] });
}
...
export declare class LanguageNotAvailableError extends ErrorResult {
    ...
    constructor(input: { languageCode: Scalars['String'] });
}
...
export declare class MimeTypeError extends ErrorResult {
    ...
    constructor(input: { fileName: Scalars['String']; mimeType: Scalars['String'] });
}
...
export declare class OrderLimitError extends ErrorResult {
    ...
    constructor(input: { maxItems: Scalars['Int'] });
}
...
export declare class ProductOptionInUseError extends ErrorResult {
    ...
    constructor(input: { optionGroupCode: Scalars['String']; productVariantCount: Scalars['Int'] });
}
...
export declare class RefundAmountError extends ErrorResult {
    ...
    constructor(input: { maximumRefundable: Scalars['Int'] });
}
