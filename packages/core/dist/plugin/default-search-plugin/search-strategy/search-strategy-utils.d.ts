 ...
 */
export declare function createFacetIdCountMap(
    facetValuesResult: Array<{
        facetValues: string;
    }>,
): Map<ID, number>;
/**
 ...
 */
export declare function createCollectionIdCountMap(
 ...
 */
export declare function applyLanguageConstraints(
