...
export declare const facetValueCollectionFilter: CollectionFilter<{
    ...
    combineWithAnd: import('../../common/configurable-operation').ConfigArgCommonDef<'boolean'> &
        import('../../common/configurable-operation').WithArgConfig<never>;
}>;
...
export declare const defaultCollectionFilters: (
    | CollectionFilter<{
          facetValueIds: {
              type: 'ID';
              list: true;
