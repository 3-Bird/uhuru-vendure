 ...
 * @docsWeight 0
 */
export declare abstract class PromotionAction<
 ...
 * @docsWeight 1
 */
export declare class PromotionItemAction<
    T extends ConfigArgs = ConfigArgs,
    U extends Array<PromotionCondition<any>> = [],
 ...
 * @docsWeight 2
 */
export declare class PromotionOrderAction<
    T extends ConfigArgs = ConfigArgs,
 ...
 * @docsWeight 3
 */
export declare class PromotionShippingAction<
    T extends ConfigArgs = ConfigArgs,
    U extends PromotionCondition[] = [],
> extends PromotionAction<T, U> {
    private readonly executeFn;
