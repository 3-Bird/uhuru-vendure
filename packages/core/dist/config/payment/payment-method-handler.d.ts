 ...
 * @docsCategory payment
 */
export declare class PaymentMethodHandler<
...
> extends ConfigurableOperationDef<T> {
    ...
    createPayment(
        ...
        | {
              ...
              state:
                  | 'Created'
                  | 'Cancelled'
                  | keyof import('../../service/helpers/payment-state-machine/payment-state').PaymentStates;
              /**
               * @description
               * The unique payment reference code typically assigned by
               * the payment provider.
    ...
    cancelPayment(
        ...
        args: ConfigArg[],
        method: PaymentMethod,
    ): Promise<CancelPaymentResult | CancelPaymentErrorResult | undefined>;
    /**
     * @description
    ...
    createRefund(
        ...
        args: ConfigArg[],
        method: PaymentMethod,
    ): Promise<false | CreateRefundResult>;
    /**
     * @description
