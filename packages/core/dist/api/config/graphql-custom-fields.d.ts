 ...
 */
export declare function addGraphQLCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
    customFieldConfig: CustomFields,
    publicOnly: boolean,
): GraphQLSchema;
export declare function addServerConfigCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
    customFieldConfig: CustomFields,
): GraphQLSchema;
export declare function addActiveAdministratorCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
 ...
 * is registered.
 */
export declare function addRegisterCustomerCustomFieldsInput(
    typeDefsOrSchema: string | GraphQLSchema,
 ...
 * type.
 */
export declare function addModifyOrderCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
 ...
 */
export declare function addOrderLineCustomFieldsInput(
    typeDefsOrSchema: string | GraphQLSchema,
    orderLineCustomFields: CustomFieldConfig[],
): GraphQLSchema;
export declare function addShippingMethodQuoteCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
    shippingMethodCustomFields: CustomFieldConfig[],
): GraphQLSchema;
export declare function addPaymentMethodQuoteCustomFields(
    typeDefsOrSchema: string | GraphQLSchema,
